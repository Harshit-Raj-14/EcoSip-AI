...
if st.button("Calculate CO2 Emissions"):
    ...
    with col4:
        ...
        st.warning(f"In 2025, CO2 emissions per capita for India are estimated to be around 1.65 tonnes per person. India's CO2 emissions per capita have been steadily increasing, driven by factors such as economic growth and energy consumption.")
