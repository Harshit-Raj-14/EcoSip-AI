  ...
  return (
    <div className="col-span-6 lg:col-span-2 relative flex justify-center  bg-gradient-to-b to-plantGreenDark from-plantGreen rounded-3xl  drop-shadow-lg  overflow-hidden ">
      ...
      <div className="justify-center mx-auto z-10">
        ...
        <div className="px-4 mb-9 relative flex mx-auto justify-center mt-9 drop-shadow-lg text-plantGreenLight h-48 w-48 lg:h-64 lg:w-64 text-2xl lg:text-4xl leading-8 font-bold tracking-tight  bg-plantGreen border-4 border-plantGreenLight rounded-[50%] overflow-hidden hover:scale-105 transition duration-200 ease-in-out">
